...
public class GuiSunTable extends GuiContainer
{
	...
	{
		String name = this.sunTableEntity.isInvintoryNameLocalized() ? this.sunTableEntity.getInventoryName() : I18n.format(this.sunTableEntity.getInventoryName());

		fontRendererObj.drawString(name, xSize/2 - fontRendererObj.getStringWidth(name)/2, 6, 4210752); //some randome color 4210752
		fontRendererObj.drawString(I18n.format("container.inventory"), 8, ySize-94, 4210752); //some randome color 4210752
	}
