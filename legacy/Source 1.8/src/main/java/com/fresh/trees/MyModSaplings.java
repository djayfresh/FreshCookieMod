...
public class MyModSaplings extends BlockSapling
{
    ...
    {
        return CookieMod.pecanSapling == this? saplingIcon[0] : saplingIcon[1];
    }
	public void growTree(World par1World, BlockPos pos,
			Random par5Random)
			{}
/*
	public void growTree(World par1World, BlockPos pos,
			Random par5Random)
	{
		if (!TerrainGen.saplingGrowTree(par1World, par5Random, pos))
			return;

		int l = par1World.getBl.getBlockMetadata(pos.getX(), pos.getY(), pos.getZ()) & 3;
		Object object = null;
		int i1 = 0;
		int j1 = 0;
		boolean flag = false;
